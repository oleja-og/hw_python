...
print("Введите песню Винни пуха : ")
list_1 = list(input().split(' '))
list_2 = ('у', 'е', 'ы', 'а', 'о', 'э', 'я', 'и', 'ю')
list_3 = list()

list(map(lambda x: list_3.append(list(filter(lambda y: y in list_2, x))),list_1))

if list_3.count(list_3[0]) == len(list_3):
    print("все ок")
else:
    print("ne ok")
print(list_3)
